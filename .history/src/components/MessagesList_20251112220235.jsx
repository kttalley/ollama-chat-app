              ...
              <div key={idx} className={`flex flex-col ${isUser ? '' : 'items-start'}`}>
                <div
                  className={`max-w-xs px-3 py-2 rounded-lg text-sm leading-relaxed break-words ${
                    isUser
                      ? 'my-[1rem] m-[0.25rem] py-[0.5rem] rounded-[1rem]'
                      : 'text-[var(--mds-color-theme-text-secondary-light)] border border-[var(--mds-color-theme-outline-secondary-normal)] rounded-[1rem]'
                  }`}
                  style={{

  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col mx-[1rem] min-height p-[0.25rem] pb-[1rem] flex-shrink-0">
      ...
      <div className="compose-header">
        {/* <Button size={28} prefixIcon='mention-filled' onClick={handleAddContext} variant="secondary" className='bg-[#fff] hover:bg-[rgba(255,255,255,0.4)] rounded-[8px] my-[0.25rem]'
      ...
      <div
        className="relative border-[1px] border-[var(--mds-color-theme-outline-secondary-normal)] bg-[#fff] rounded-[12px] transition-all duration-300 overflow-visible"
        style={{
      ...
      >
        ...
        {/* Inner Container */}
        <div className="px-[0.5rem] py-[0.5rem] flex flex-col justify-between bg-[#fff] max-h-[200px] rounded-[12px] p-3 flex flex-col gap-2 focus-within:ring-1 focus-within:ring-blue-500/10"
          style={{
            ...
            <textarea
              ...
              placeholder={
                isProcessing
                  ...
                  : isListening
                    ? 'Listening...'
                    : 'Type or speak your question to the LLM Agent'
              }
              rows={3}

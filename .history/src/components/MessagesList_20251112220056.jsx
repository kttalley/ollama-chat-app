    ...
    <div className="flex-1 overflow-y-auto p-4 space-y-3 mx-[1rem] pb-[2rem]">
      {displayMessages.length === 0 ? (
        <div className="flex flex-col justify-center items-center h-full text-center text-gray-600">
          <Icon name="cisco-ai-assistant-color-gradient" className="scale-400" />
              ...
              <div key={idx} className={`flex flex-col ${isUser ? '' : 'items-start'}`}>
                <div
                  className={`max-w-xs px-3 py-2 rounded-lg text-sm leading-relaxed break-words ${
                    isUser
                      ? 'bg-[var(--mds-color-theme-background-glass-normal)] my-[1rem] m-[0.25rem] py-[0.5rem] rounded-[1rem]'
                      : 'text-[var(--mds-color-theme-secondary-light)] border border-[var(--mds-color-theme-outline-secondary-normal)] rounded-[1rem] bg-[var(--mds-color-theme-background-glass-normal)]'
                  }`}
                  style={{
            ...
            <div className="flex flex-col items-start">
              <div
                ...
                style={{
                  ...
                  padding: '1rem 1rem 0.75rem 1.25rem',
                  boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)',
                  backgroundColor: 'var(--mds-color-theme-background-glass-normal)',

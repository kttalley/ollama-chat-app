  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col mx-[1rem] min-height p-[0.25rem] pb-[1rem] flex-shrink-0">
      ...
      >
        ...
        {/* Inner Container */}
        <div className="px-[0.5rem] py-[0.5rem] flex flex-col justify-between bg-[#fff] max-h-[200px] border=[1px] border-[var(--mds-color-theme-control-active-normal)] rounded-[12px] p-3 flex flex-col gap-2 focus-within:ring-1 focus-within:ring-blue-500/10"
          style={{

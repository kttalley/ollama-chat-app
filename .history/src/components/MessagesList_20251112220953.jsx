              ...
              <div key={idx} className={`flex flex-col ${isUser ? '' : 'items-start'}`}>
                <div
                  className={`max-w-xs px-3 py-2 rounded-lg text-sm leading-relaxed break-words ${
                    isUser
                      ? 'bg-[#ffffff54] my-[1rem] m-[0.25rem] py-[0.5rem] rounded-[1rem]'
                      : 'text-[var(--mds-color-theme-secondary-light)] border-[1px] border-[var(--mds-color-theme-outline-secondary-normal)] rounded-[1rem] bg-[var(--mds-color-theme-background-glass-normal)]'
                  }`}
                  style={{

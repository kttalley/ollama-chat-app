...
import { ThemeProvider, IconProvider, Icon, Button } from '@momentum-design/components/dist/react'
  ...
  return (
    <ThemeProvider themeclass="mds-color-theme-darkWebex" >
      <IconProvider iconSet="custom-icons" url="svg" className="mds-typography mds-elevation">
        <Button className="bg-blue-500 text-white" variant="primary" onClick={() => console.log('clicked')}>hi</Button>
        <Icon name="send-bold" className="w-6 h-6" />
    <div className="h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
      ...
      <main className="flex-1 overflow-auto">
        <MessagesList messages={messages} isLoading={streaming} />
      </main>

      <footer className="flex-shrink-0 bg-white dark:bg-gray-800">
